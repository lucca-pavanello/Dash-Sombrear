export const tbl = {
  ...
  th:          'px-4 py-3 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground border-r border-border',
  tbodyRow:    'border-b border-border/60 last:border-0 hover:bg-muted/30 transition-colors duration-150',
  td:          'px-4 py-3 text-sm text-foreground border-r border-border/60 align-middle',
